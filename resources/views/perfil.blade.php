            ...
            @endif
                ...
                <form method="POST" action="{{ route('perfil-actualizar') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="telefono" type="number" class="form-control @error('telefono') is-invalid @enderror" name="telefono" value="{{Auth::user()->telefono}}" required autocomplete="telefono" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="nombre_cargo" aria-label="Default select example" class="form-control @error('nombre_cargo') is-invalid @enderror" name="nombre_cargo" value="{{ old('nombre_cargo') }}" required autocomplete="producto_categoria" autofocus>
                                    <option value={{Auth::user()->cargo}} selected>{{Auth::user()->cargo}}</option>
                                        @if(Auth::user()->cargo == "Usuario")
                ...
                <div class="perfil-titulo">Actualizar Contraseña</div>
